...
This module provides shared data structures and helpers for mixture
vapor–liquid equilibrium, liquid–liquid equilibrium, density, vapor-pressure,
and critical-point calculations using PC-SAFT models.
"""
